    ...
    <div className="community-page">
      <div className="community-header">
        <div className="community-header-title">
          ...
          <span>
            Create & Vote on balance suggestions from the community.
          </span>
        </div>
      ...
      <div className="create-suggestion-section">
        ...
        >
          <div className="suggestion-form">
            ...
            <div className="suggestion-input-group">
              ...
              <textarea
                placeholder="Explain your balance suggestion..."
                value={comment}
                onChange={(e) =>
        ...
        {showSuggestionForm && (
          <button
            className="post-suggestion-button"
      ...
      {comments.length === 0 ? (
        <div className="comments-empty">
          ...
          <span>
            Write your first comment and it'll appear here.
          </span>
        </div>
      ) : (
        <div className="comments-container">
          {filteredComments.map((savedComment) => {
            const matchedCard = cards.find(
              (card) =>
                card.name === savedComment.card
            );
              ...
              >
                <div className="comment-header">
                  ...
                  <div className="comment-title">
                    ...
                    <span
                      className={`comment-type comment-type-${savedComment.type
                        .toLowerCase()
                        .replaceAll(" ", "-")}`}
                    >
                      {savedComment.type}
