...
export default function SuggestedDecks() {
  ...
  const { handleClickedButton, editedDeck, setEditedDeck, updateSuggestedDeck, deleteSuggestedDeck } = useSuggestedDecks();
        ...
        return (
          <div className="suggested-deck-row" key={deck.id}>
            <div className="deck-box">
              <div className="deck-header">
                ...
                {isEditing && (
                  <div className="deck-edit-actions">
                    <button className="deck-cancel-button" onClick={() => setEditedDeck(null)}>
                      Cancel
                    </button>

                    <button className="deck-submit-button" onClick={() => updateSuggestedDeck(editedDeck)}>
                      Submit
                    </button>
                  </div>
                )}

                <button className="deck-update-button" onClick={() => handleClickedButton(deck)}>
                  <NotebookPen />
                </button>
              </div>
              ...
              <div className="suggested-deck-cards">
                {deck.cards.map((deckCard) => {
                  ...
                  return (
                    <div className="suggested-deck-card" key={deckCard}>
                      <img src={matchedCard.imageUrl} alt={matchedCard.name} />
                    </div>
                  );
                })}
              </div>
            ...
            <div className="deck-delete-container">
              <button className="deck-delete-button" onClick={() => deleteSuggestedDeck(deck.id)}>
                <X />
              </button>
            </div>
          </div>
